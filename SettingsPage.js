...
export default function SettingsPage({navigation}) {
    ...
    return(
        <SafeAreaView style={SettingsPageStyleSheet.container} onLayoutRootView={onLayoutRootView}>
            ...
            <TouchableOpacity style={SettingsPageStyleSheet.backIconContainer} onPress={()=>{console.log("Pressed");
                    navigation.navigate('ConvoPage')}}>
                    <Image source={require('./assets/icons/BackIcon.png')}  style={SettingsPageStyleSheet.backIcon} />
                </TouchableOpacity>
                <Text style={SettingsPageStyleSheet.title}>{global.appText.settingsTitle}</Text>
		    </View>
            ...
            <View style={SettingsPageStyleSheet.languageSelectorContainer}>
                <ScrollView style={SettingsPageStyleSheet.languageSelector}>
